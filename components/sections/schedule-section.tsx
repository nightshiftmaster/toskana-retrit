  ...
  return (
    <section ref={ref} className="py-20 md:py-32 px-4 bg-stone-100">
      ...
      >
        ...
        <motion.div variants={scaleIn} className="bg-stone-200 p-8 md:p-12 text-left">
          <motion.div variants={staggerContainer} className="text-stone-700 leading-relaxed space-y-6 font-light">
            ...
            <motion.p variants={staggerItem} className="text-center font-medium text-stone-800 pt-4">
              17 августа — отъезд.
            </motion.p>
          </motion.div>
          ...
          <motion.div variants={staggerContainer} className="mt-8 text-stone-700 leading-relaxed space-y-4 font-light">
            <motion.p variants={staggerItem}>
              <strong>В стоимость входит:</strong> проживание, трансфер, завтраки, экскурсия на Сыроварню, практики
              Йоги, медитации и Танцевально-двигательной терапии, арт-класс от Итальянского художника, поездка во
              Флоренцию с посещением Галереи УФФИЦИ, профессиональная фотосессия.
            </motion.p>
            <motion.p variants={staggerItem}>
