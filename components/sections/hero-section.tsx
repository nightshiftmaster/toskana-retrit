...
const HeroSection = forwardRef<HTMLElement, HeroSectionProps>(
  ({ scrollToSection, bookingRef }, ref) => {
    return (
      <section
        ref={ref}
      ...
      >
        <div className=" max-w-[1500px] mx-auto flex flex-col items-center justify-center relative -mt-14">
          ...
          <div className="absolute top-12 text-slate-100 flex flex-col items-center justify-center gap-[3vh] w-full p-4">
            ...
            >
              Йога, эстетика, танец, искусство, фотосессия и итальянская любовь
              к жизни — в уникальном путешествии для женщин, которые хотят
              больше, чем просто отпуск.
            </motion.p>
            ...
            <Button
              ...
              className="md:w-1/4 w-fit mt-14 bg-green-100 hover:bg-fuchsia-100 text-amber-950 px-6 py-3 text-sm font-medium tracking-wider uppercase font-sans"
            >
              ЗАБРОНИРОВАТЬ
            </Button>
          </div>
