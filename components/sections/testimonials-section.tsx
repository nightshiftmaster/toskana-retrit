...
Спасибо что дала нам почувствовать это новое состояние`,
    ...
    },
    {
      ...
      name: "Лейла Ошер",
      text: `Рим начался с практики Йоги  под руководством Юлички и великолепного завтрака. 
Заряд бодрости  и адреналина перед предстоящим днём посещения Ватикана.
Это сложно передать словами, нужно это просто почувствовать.  
Вообщем  подводя итоги моей поездки могу сказать,  девочки не упустите свой шанс,  смело отправляйтесь в это путешествие и не на секунду не пожалеете от этом. ❤️😉`,
      place: "Девичник в Риме",
    },
  ];
