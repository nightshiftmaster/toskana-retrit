        ...
        >
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-stone-200 p-6 text-center"
            >
              <motion.div
                whileHover={{ scale: 1.1, rotate: 5 }}
                className="w-16 h-16 bg-stone-300 rounded-full mx-auto mb-4 flex items-center justify-center"
              >
                <span className="text-stone-600 font-serif text-lg">
                  {testimonial.name[0]}
                </span>
              </motion.div>
              <motion.div
